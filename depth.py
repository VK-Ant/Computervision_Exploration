    ...
    while cap.isOpened():
        ...
        if results.detections:
            for id, detection in enumerate(results.detections):
                ...
                cv2.putText(img, f'{int(detection.score[0]*100)}%', (boundBox[0],
                            boundBox[1] - 20), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 2)
        ...
        cv2.putText(img, "Depth in cm: " + str(round(depth_face, 2)*100),
                    (50, 400), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 255, 0), 3)
